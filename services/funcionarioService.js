...
class funcionarioService {
    ...
    async Create(idCriadouro, nome, cpf, email, genero, descCargo, telefone, dataNasc, endereco) {
        try {
            const newFuncionario = new Funcionario({
                idCriadouro, nome, cpf, email, genero, descCargo, telefone, dataNasc, endereco
            })
    ...
    async Update(id, idCriadouro, nome, cpf, email, genero, descCargo, telefone, dataNasc, endereco){
        try{
